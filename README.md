...
1. What gem is it trying to load.
   place binding.pry in config/environment.rb
   $LOAD_PATH
2. Go there
   cd $LOAD_PATH

3. If the version is different, meaning if it's trying to load
 version 1.4 but we have version 1.3, then in the gemfile
 require_all, '1.3'
